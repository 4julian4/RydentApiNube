...
{
    public sealed class ObtenerOdontogramaInicialAccionWorker : IAccionWorker
    {
        public string NombreAccion => "ODONTOGRAMA_OBTENER_INICIAL";
        ...
        private static OdontogramaLegacyRow MapearLegacyRow(JsonElement row)
        {
            return new OdontogramaLegacyRow
            {
                ...
                Firma = GetNullableInt(row, "FIRMA")
            };
        }
            ...
            string claveResultado)
        {
            ...
            var filas = elemento.EnumerateArray();
